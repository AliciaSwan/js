...
// function start() {
//   gapi.client.init({
//     'apiKey': 'YAIzaSyBMsNwfwfHv-7hhXwERWSKCc-srqFLO4Vc',
//     'discoveryDocs': ['https://people.googleapis.com/$discovery/rest'],'discoveryDocs': ['https://www.googleapis.com/discovery/v1/apis/youtube/v3/rest'],
//   }).then(function() {
...
function start(){
    gapi.client.init({
        'apiKey':'AIzaSyBMsNwfwfHv-7hhXwERWSKCc-srqFLO4Vc',
